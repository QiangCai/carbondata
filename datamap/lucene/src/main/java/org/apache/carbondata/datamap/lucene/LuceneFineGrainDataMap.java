...
public class LuceneFineGrainDataMap extends AbstractFineGrainDataMap {
  ...
  public LuceneFineGrainDataMap(AbsoluteTableIdentifier tableIdentifier, String dataMapName,
   ...
   */
  public List prune(FilterResolverIntf filterExp, SegmentProperties segmentProperties,
    ...
    // Map<BlockId, Map<BlockletId, Map<PageId, Set<RowId>>>>
    for (Map.Entry<String, Map<String, Map<Integer, Set<Integer>>>> mapBlock : mapBlocks
        .entrySet()) {
