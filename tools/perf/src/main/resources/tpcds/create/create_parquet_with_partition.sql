...
insert overwrite table inventory partition(inv_date_sk) select inv_item_sk,inv_warehouse_sk,inv_quantity_on_hand,inv_date_sk from ${SOURCE}.inventory distribute by inv_date_sk;
